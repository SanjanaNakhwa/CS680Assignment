...
public class FileCrawlingVisitorTest {
    ...
    @Test
    public void getFilesForUserWithCorrectPasswordTest() {
    ...
    @Test
    public void getFilesForUserWithInCorrectPasswordTest() {
        SecurityContext ctx = new SecurityContext("ABC");
        ctx.login("1234");
        visitor = new FileCrawlingVisitor();
        root.accept(visitor, ctx);
        ...
        expected.add(a);
        expected.add(b);
        assertNotEquals(visitor.getFiles().toArray(), expected.toArray());
    }
}
