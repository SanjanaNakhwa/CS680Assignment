...
public class CountingVisitorTest {
    ...
    @Test
    public void getDirNumForUserWithCorrectPasswordTest() {
    ...
    @Test
    public void getFileNumForUserWithCorrectPasswordTest() {
        SecurityContext ctx = new SecurityContext("ABC");
        ctx.login("123");
        visitor = new CountingVisitor();
        root.accept(visitor, ctx);
    ...
    @Test
    public void getLinkNumForUserWithCorrectPasswordTest() {
        SecurityContext ctx = new SecurityContext("ABC");
        ctx.login("123");
        visitor = new CountingVisitor();
        root.accept(visitor, ctx);
    ...
    @Test
    public void getDirNumForUserWithInCorrectPasswordTest() {
        SecurityContext ctx = new SecurityContext("ABC");
        ctx.login("1234");
        visitor = new CountingVisitor();
        root.accept(visitor, ctx);
        assertNotEquals(5, visitor.getDirNum());
    }

    @Test
    public void getFileNumForUserWithInCorrectPasswordTest() {
        SecurityContext ctx = new SecurityContext("ABC");
        ctx.login("1234");
        visitor = new CountingVisitor();
        root.accept(visitor, ctx);
        assertNotEquals(5, visitor.getFileNum());
    }

    @Test
    public void getLinkNumForUserWithInCorrectPasswordTest() {
        SecurityContext ctx = new SecurityContext("ABC");
        ctx.login("1234");
        visitor = new CountingVisitor();
        root.accept(visitor, ctx);
        assertNotEquals(2, visitor.getLinkNum());
    }
}
